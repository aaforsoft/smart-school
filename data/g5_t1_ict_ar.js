...
// full-video -----------
var g5_t1_ict_ar_fullvideo = [
  {
    video_title: "",
    video_link: "",
  },
  {
    video_title: "مستر محمد ابراهيم - مراجعة التميز نهاية الترم 2024",
    video_link: "https://www.youtube.com/embed/9xEhTjOwQDU?si=sAOvdD40ETLpHoVa",
  },
];

let g5_t1_ict_ar_fullvideo_elements = "";
g5_t1_ict_ar_fullvideo.forEach(function (item) {
  g5_t1_ict_ar_fullvideo_elements += draw_fullvideo_list(item);
});

document.getElementById("g5_t1_ict_ar_fullvideo").innerHTML +=
  g5_t1_ict_ar_fullvideo_elements;
//-------------------
